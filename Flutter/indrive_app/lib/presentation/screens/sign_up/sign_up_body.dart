                    ...
                    child: Column(
                      children: [
                        ...
                        TextFormFieldWidget(
                          ...
                          validator: (value) => signUpBlocState.name.error,
                        ),
                        TextFormFieldWidget(
                          text: 'Apellido',
                          ...
                          validator: (value) => signUpBlocState.lastname.error,
                        ),
                        TextFormFieldWidget(
                          text: 'Email',
                          ...
                          validator: (value) => signUpBlocState.email.error,
                        ),
                        TextFormFieldWidget(
                          text: 'Telefono',
                          ...
                          validator: (value) => signUpBlocState.phone.error,
                        ),
                        TextFormFieldWidget(
                          text: 'Contraseña',
                          ...
                          validator: (value) => signUpBlocState.password.error,
                        ),
                        TextFormFieldWidget(
                          ...
                          onChange: (text) {
                            context.read<SignUpBloc>().add(
                              ConfirmPasswordChangedEvent(
                                confirmPassword: ValidateDataBloc(value: text),
                              ),
                            );
                          },
                          validator:
                              (value) => signUpBlocState.confirmPassword.error,
                        ),
                        ButtonWidget(
                          text: 'Sign Up',
                          onPush: () {
