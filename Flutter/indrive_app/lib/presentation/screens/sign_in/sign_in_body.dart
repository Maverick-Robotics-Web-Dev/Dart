...
class SignInBody extends StatelessWidget {
  final SignInBlocState signInBlocState;

  const SignInBody({super.key, required this.signInBlocState});

  @override
  Widget build(BuildContext context) {
    return Form(
      key: signInBlocState.formKey,
      child: Stack(
        children: [
          Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        TextFormFieldWidget(
                          ...
                          validator: (value) => signInBlocState.email.error,
                        ),
                        TextFormFieldWidget(
                          text: 'Password',
                          ...
                          validator: (value) => signInBlocState.password.error,
                        ),
                        ButtonWidget(
                          text: 'Sign In',
                          onPush: () {
                            signInBlocState.formKey!.currentState!.validate()
                                ? context.read<SignInBloc>().add(
                                  FormSubmitEvent(),
                                )
