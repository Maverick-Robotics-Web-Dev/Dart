...
import 'package:e_commerce_valamy/src/presentation/screens/profile/profile_tablet_screen.dart';
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          if (constraints.maxWidth <= ScreenSizes.xLarge &&
            ...
            return ProfileTabletScreen(textTheme: textTheme);
          } else {
            return ProfileMobileScreen(textTheme: textTheme);
          }
        },
      ),
    );
