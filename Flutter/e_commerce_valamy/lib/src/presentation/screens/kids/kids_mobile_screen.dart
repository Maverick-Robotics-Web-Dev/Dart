                ...
                SliverPadding(
                  ...
                  sliver: SliverGrid(
                    ...
                    delegate: SliverChildBuilderDelegate((
                      ...
                      return ProductCard(
                        image: state.kidsProducts[index].image,
                        brandName: state.kidsProducts[index].brandName,
                        title: state.kidsProducts[index].title,
                        price: state.kidsProducts[index].price,
                        priceAfetDiscount:
                            state.kidsProducts[index].priceAfetDiscount,
                        dicountpercent:
                            state.kidsProducts[index].dicountpercent,
                        press: () {
                          Navigator.pushNamed(
                            context,
                    ...
                    }, childCount: state.kidsProducts.length),
                  ),
                ),
              ],
            ),
