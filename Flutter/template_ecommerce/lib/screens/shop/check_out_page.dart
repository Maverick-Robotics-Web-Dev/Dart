...
import 'package:template_ecommerce/screens/address/add_address_page.dart';
import 'package:template_ecommerce/screens/payment/unpaid_page.dart';
...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder:
            (_, constraints) => SingleChildScrollView(
...
class Scroll extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRect(
      ...
      Paint()..shader = grT.createShader(Rect.fromLTRB(0, 0, size.width, 30)),
    );
